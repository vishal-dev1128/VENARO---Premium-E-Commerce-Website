    ...
    <div class="row">
            ...
            <div class="filter-card shadow-sm mb-4">
                ...
                <div class="filter-group-body">
                    ...
                    <div class="mb-4">
                        ...
                        <button class="btn btn-sm btn-dark w-100 mt-3" onclick="applyPriceFilter()" style="border-radius: 8px; padding: 10px;">Apply</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-9">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <span class="text-muted">Showing <?php echo $offset + 1; ?>-<?php echo min($offset + PRODUCTS_PER_PAGE, $total_products); ?> of <?php echo $total_products; ?></span>
                </div>
                <div>
