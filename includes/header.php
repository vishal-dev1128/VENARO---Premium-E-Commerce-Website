        ...
        <div class="container-fluid px-4">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-none d-lg-flex align-items-center me-1">
                    ...
                    <a href="mailto:contact.venaro@gmail.com"
                ...
                <?php if (is_logged_in()): ?>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end p-0" style="min-width: 240px; border: none; border-radius: 0; box-shadow: 0 12px 48px rgba(0,0,0,0.14); overflow: hidden; margin-top: 12px;">

                            <!-- User Info Card -->
                            <div style="background: #0a0a0a; padding: 24px 20px; text-align: center; border-bottom: 1px solid rgba(255,255,255,0.08);">
                                <!-- Avatar with Initials -->
                                <div style="width: 54px; height: 54px; border-radius: 50%; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15); display: flex; align-items: center; justify-content: center; margin: 0 auto 14px; font-family: 'Playfair Display', serif; font-size: 20px; font-weight: 700; color: #fff; letter-spacing: 1px;">
                                    <?php echo strtoupper(substr($_SESSION['user_name'] ?? 'U', 0, 1)); ?>
                                </div>
                                <div style="font-family: 'Playfair Display', serif; font-size: 15px; font-weight: 600; color: #fff; letter-spacing: 0.5px; margin-bottom: 4px;">
                                    <?php echo htmlspecialchars($_SESSION['user_name'] ?? ''); ?>
                                </div>
                                <div style="font-family: 'Inter', sans-serif; font-size: 11px; color: rgba(255,255,255,0.4); letter-spacing: 0.5px;">
                            ...
                            <div style="background: #fff; padding: 8px 0;">
                                <a href="<?php echo SITE_URL; ?>/profile.php" style="display: flex; align-items: center; gap: 12px; padding: 12px 20px; text-decoration: none; color: #111; font-family: 'Montserrat', sans-serif; font-size: 11px; font-weight: 600; letter-spacing: 1px; text-transform: uppercase; transition: background 0.2s;" onmouseover="this.style.background='#f5f5f5'" onmouseout="this.style.background='transparent'">
                                    <i class="material-icons" style="font-size: 16px; color: #666;">person_outline</i> My Profile
                                </a>
                                <a href="<?php echo SITE_URL; ?>/orders.php" style="display: flex; align-items: center; gap: 12px; padding: 12px 20px; text-decoration: none; color: #111; font-family: 'Montserrat', sans-serif; font-size: 11px; font-weight: 600; letter-spacing: 1px; text-transform: uppercase; transition: background 0.2s;" onmouseover="this.style.background='#f5f5f5'" onmouseout="this.style.background='transparent'">
                                    <i class="material-icons" style="font-size: 16px; color: #666;">receipt_long</i> My Orders
                                </a>
                                <a href="<?php echo SITE_URL; ?>/wishlist.php" style="display: flex; align-items: center; gap: 12px; padding: 12px 20px; text-decoration: none; color: #111; font-family: 'Montserrat', sans-serif; font-size: 11px; font-weight: 600; letter-spacing: 1px; text-transform: uppercase; transition: background 0.2s;" onmouseover="this.style.background='#f5f5f5'" onmouseout="this.style.background='transparent'">
                                    <i class="material-icons" style="font-size: 16px; color: #666;">favorite_border</i> Wishlist
                                </a>
                                <div style="height: 1px; background: #f0f0f0; margin: 6px 0;"></div>
                                <a href="<?php echo SITE_URL; ?>/logout.php" style="display: flex; align-items: center; justify-content: center; gap: 8px; margin: 10px 16px; padding: 11px 16px; text-decoration: none; color: #0a0a0a; font-family: 'Montserrat', sans-serif; font-size: 10px; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; border: 1px solid #0a0a0a; transition: all 0.3s;" onmouseover="this.style.background='#0a0a0a';this.style.color='#fff'" onmouseout="this.style.background='transparent';this.style.color='#0a0a0a'">
                                    <i class="material-icons" style="font-size: 15px;">logout</i> Sign Out
                                </a>
                            </div>
                        </div>
                    </div>
