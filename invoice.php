    ...
    <div class="invoice-box shadow-sm rounded">
        <div class="row mb-5 align-items-start">
            ...
            <div class="col-sm-6 text-sm-end">
                ...
                <p class="mb-0 text-muted">Date: <?php echo date('F j, Y', strtotime($order['created_at'])); ?></p>
            </div>
        </div>
        ...
        <div class="row mb-5">
            <div class="col-sm-6 mb-4 mb-sm-0">
                ...
                <p class="mb-1 fw-bold font-brand" style="font-size: 1.1rem;">VÉNARO APPAREL</p>
                <p class="mb-1 text-muted">contact.venaro@gmail.com</p>
                <p class="mb-0 text-muted">+91 96659 97194</p>
            </div>
            <div class="col-sm-6 text-sm-end">
        ...
        <div class="mt-5 pt-5 border-top text-center">
            ...
            <p class="text-muted small">© <?php echo date('Y'); ?> Vénaro Apparel. All rights reserved.</p>
        </div>
    </div>
</div>
